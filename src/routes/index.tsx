  ...
  head: () => ({
    meta: [
      { title: "PrepPilot — From Resume to Ready" },
      {
        name: "description",
        content:
          "The AI career cockpit that reads your resume, runs adaptive interviews, evaluates every answer, and builds your path to interview readiness.",
      },
      { property: "og:title", content: "PrepPilot — From Resume to Ready" },
      {
        property: "og:description",
        content:
          "The AI career cockpit for interview readiness. Resume-aware, adaptive, measurable.",
      },
...
const problems = [
  {
    ...
    body: "Question banks that ignore who you are, what you built, and what you're actually interviewing for.",
  },
  {
    icon: FileText,
    title: "No Resume Context",
    body: "Prep tools never open your resume — so they never ask about the projects that will really come up.",
  },
  {
    icon: Brain,
    title: "Static Interviewing",
    body: "Real interviewers dig deeper when you're strong and pivot when you're weak. Static tools can't.",
  },
  {
    icon: PuzzleIcon,
    title: "Fragmented Feedback",
    body: "Scattered rubrics, no clear picture of a great answer, no next step you can act on.",
  },
  {
    icon: RefreshCw,
    title: "No Improvement Loop",
    body: "You practice, get a score, and forget. Nothing compounds across sessions.",
  },
];
...
const pillars = [
  {
    ...
    body: "Upload your resume once. PrepPilot extracts your skills, projects, technologies, and interview angles into a structured candidate profile.",
  },
  {
    icon: Compass,
    title: "Adaptive Interviewing",
    body: "An interviewer that references your actual work, calibrates difficulty in real time, and pivots when you drift.",
  },
  {
    icon: Target,
    title: "Evaluation Intelligence",
    body: "Every answer scored across five dimensions with strengths, gaps, and an ideal answer you can learn from.",
  },
  {
    icon: LineChart,
    title: "Improvement Loop",
    body: "A rolling readiness score, personalized focus areas, and a clear path from where you are to where the room needs you to be.",
  },
];
...
function Landing() {
  ...
  const primaryCta = authed
    ...
    : { to: "/auth", label: "Start preparing free" };
        ...
        <div className="relative mx-auto grid max-w-6xl gap-12 px-6 py-20 sm:py-28 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="animate-in-up">
            ...
            <h1 className="mt-6 font-display text-[2.75rem] font-semibold leading-[1.02] tracking-tight sm:text-6xl md:text-7xl">
              From <span className="text-gradient">Resume</span>
              <br />
              to <span className="italic font-light">Ready.</span>
            </h1>
          ...
          <div className="mt-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {problems.map((p, i) => (
              <Surface key={p.title} interactive className="p-6 animate-in-up">
                ...
                <span className="absolute right-4 top-4 font-mono text-[10px] text-muted-foreground/60">
                  0{i + 1}
                </span>
              </Surface>
            ))}
            ...
            {[
              {
                icon: FileText,
                title: "Understand",
                body: "Parse your resume into a structured candidate profile.",
              },
              {
                icon: Compass,
                title: "Interview",
                body: "Adaptive AI interviewer, tailored per session.",
              },
              {
                icon: Target,
                title: "Evaluate",
                body: "Five-dimensional scoring on every answer.",
              },
              {
                icon: Sparkles,
                title: "Improve",
                body: "Ideal answers, missing concepts, focus areas.",
              },
      ...
      <section className="relative border-t border-border/60">
        ...
        <div className="relative mx-auto max-w-3xl px-6 py-24 text-center">
          ...
          <h2 className="mt-4 font-display text-4xl font-semibold tracking-tight sm:text-5xl">
            Your first adaptive interview
            <br />
            is two minutes away.
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Upload your resume, pick a role, and step into a focused interview room with an AI that
      ...
      <Surface elevated className="relative overflow-hidden p-5">
        ...
        <div className="relative mt-4 space-y-3 text-sm">
          <PreviewBubble role="ai" topic="System Design" difficulty={3}>
            You listed a real-time analytics project on your resume. How did you handle out-of-order
            events in that pipeline?
          </PreviewBubble>
          <PreviewBubble role="user">
            We used event-time watermarks with a small lateness window and side-outputted anything
            beyond it for reprocessing…
          </PreviewBubble>
          <PreviewBubble role="ai" topic="System Design" difficulty={4}>
            Good — how did you tune the lateness window without inflating latency for the 99th
            percentile?
          </PreviewBubble>
      ...
      >
        {topic && (
          <div className="mb-1 flex gap-1.5 text-[10px] font-medium uppercase tracking-widest text-muted-foreground">
            <span>{topic}</span>
            {difficulty && <span>· Lv {difficulty}</span>}
          </div>
        )}
        {children}
      </div>
